...
export default function ContactUs() {
    ...
    const handleSubmit = (e) => {
        ...
        if (name === '') {
            ...
            setErr('Enter a message'); message
            setErrState(true)
    ...
    return (
        <section className="text-gray-600 body-font relative" style={{ marginTop: '-40px' }}>
            <div className="container max-w-screen-xl px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap" >
                <div className="lg:w-2/3 md:w-1/2  rounded-3xl overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative" style={{ backgroundColor: '#2F2F2F' }}>
                    ...
                    <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                        <div className="lg:w-1/2 px-6">
                            ...
                            <p className="mt-1">Shangrilla Rd, E-8/1 E 8/1 E-8, Islamabad, Islamabad Capital Territory</p>
                        </div>
                        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                            <a href="mailto:saad.amir28@gmail.com" className="text-indigo-500 leading-relaxed">saad.amir28@gmail.com</a>
                ...
                <div className="w-full rounded-3xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0" style={{ backgroundColor: '#2F2F2F' }}>
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <h1 className="text-xl leading-tight tracking-tight md:text-2xl" style={{ color: '#C39601' }}>Feedback</h1>
                        <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div>
                                <label htmlFor="message" className="block mb-2 text-sm font-medium " style={{ color: '#F6F6F6' }}>
                                    Message
                                </label>
                                <textarea
                                    name="message"
