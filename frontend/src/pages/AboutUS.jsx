        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap  items-center justify-center">
            <div className="flex flex-col items-center justify-center">
              <div
                className="w-96 rounded-3xl shadow border m-5 flex flex-col items-center"
              ...
              >
                ...
                <div className="md:space-y-2 sm:p-8 flex flex-col items-center justify-center">
                  ...
                  <p style={{ color: "#F6F6F6" }} className="text-center">
                    ...
                    discover that while public service improves the lives and
                    the world around you, its greatest reward is the enrichment
